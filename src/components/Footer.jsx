      ...
      <div className="container mx-auto px-8 md:px-16 lg:px-24 bg-opacity-75">
        <div className="flex flex-col md:flex-row md:space-x-12 items-center mb-4">
          <div className="flex-1 mb-4 md:mb-0">
            <h3 className="text-2xl font-bold mb-2">Thiago Vilchez</h3>
            <p className="text-gray-400">
              Desarrollador Full-Stack con base en Argentina, en el Instituto Remedio Escalada de San Martin, especializado en webs y desarrollo de software.
            </p>
          </div>
        ...
        <div className="border-t border-gray-600 pt-4 flex flex-col md:flex-row justify-between items-center">
          <p className="text-gray-400">
            &copy; {new Date().getFullYear()} Thiago Vilchez, tu programador de confianza.
          </p>
